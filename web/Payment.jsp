...
<html>
  ...
  <td><%= payment.getCardNum() %></td>
    ...
    <a href="Main.jsp" class="btn btn-primary" role="button">back</a> <a href="CreatePayment.jsp" class="btn btn-primary" role="button">create</a>
    </div>
